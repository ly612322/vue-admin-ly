    ...
    <el-card class="box-card">
      ...
      <el-card shadow="hover" class="box-card1">
        <el-table
          ...
          highlight-current-row
        >
          <el-table-column prop="LOT" label="LOT" width="100" align="center" sortable>
            <template slot-scope="scope">
              <span>{{scope.row.LOT}}</span>
            </template>
          </el-table-column>
          <el-table-column prop="SHEET" label="SHEET" width="200" align="center" sortable>
            <template slot-scope="scope">
              <span>{{scope.row.SHEET}}</span>
            </template>
          </el-table-column>
          <el-table-column prop="PANEL" label="PANEL" width="200" align="center" sortable>
            <template slot-scope="scope">
              <span>{{scope.row.PANEL}}</span>
            </template>
          </el-table-column>
          <el-table-column prop="品名" label="品名" width="150" align="center" sortable>
            <template slot-scope="scope">
              <span>{{scope.row.品名}}</span>
            </template>
          </el-table-column>
          <el-table-column prop="设备" label="设备" width="100" align="center" sortable>
            <template slot-scope="scope">
              <span>{{scope.row.设备}}</span>
            </template>
          </el-table-column>
          <el-table-column prop="大工程" label="大工程" width="100" align="center" sortable>
            <template slot-scope="scope">
              <span>{{scope.row.大工程}}</span>
            </template>
          </el-table-column>
          <el-table-column prop="小工程" label="小工程" width="100" align="center" sortable>
            <template slot-scope="scope">
              <span>{{scope.row.小工程}}</span>
            </template>
          </el-table-column>
          <el-table-column prop="备注" label="备注" width="250" align="center" sortable>
            <template slot-scope="scope">
    ...
    <el-card class="box-card2">
      <el-col>
        ...
        <el-button-group style="float:left;margin-left:10px;">
          ...
          <el-button type="primary">ARRAY</el-button>
          <el-button type="primary">CELL</el-button>
        </el-button-group>
      </el-col>
